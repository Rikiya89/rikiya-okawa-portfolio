...
export default function ProjectModalContent({
  ...
  const techChipClassName = isJp
    ? "accent-chip rounded-full border px-4 py-1.5 text-sm md:text-base font-panno"
    : "accent-chip rounded-full border px-4 py-1.5 text-sm md:text-base font-panno";
  const actionButtonClassName =
    "button-primary text-center text-white cursor-pointer rounded-lg w-full md:w-auto md:max-w-[220px] font-panno text-base md:text-lg inline-flex items-center justify-center px-4 md:px-6 py-2.5 min-h-[44px] whitespace-nowrap transition-transform duration-200 ease-out md:hover:scale-[1.02] active:scale-[0.98]";
